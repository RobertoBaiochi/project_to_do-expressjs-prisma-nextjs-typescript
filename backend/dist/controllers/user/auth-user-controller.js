...
var auth_user_controller_exports = {};
__export(auth_user_controller_exports, {
  authUserController: () => authUserController
});
module.exports = __toCommonJS(auth_user_controller_exports);
...
var authUserService = (contentBody) => __async(void 0, null, function* () {
  ...
  try {
    ...
    const matchPassword = yield (0, import_bcrypt.compare)(password, user.password);
    if (!matchPassword) {
